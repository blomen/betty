...
class ResponseCache:
    ...
    def __init__(self, default_ttl_seconds: int = 300, max_entries: int = 1000, per_provider: bool = True):
        """
    ...
    def _get_provider_cache(self, provider_id: str | None) -> OrderedDict:
        """
    ...
    def get(self, url: str, params: dict | None = None, provider_id: str | None = None) -> Any | None:
        """
        Get cached response.
    ...
    def set(
        ...
        with self._lock:
            ...
            # Create entry
            entry = CacheEntry(value=value, created_at=time.time(), ttl_seconds=ttl)
    ...
    def clear(self, provider_id: str | None = None):
        """
        Clear cache.
    ...
    def get_provider_stats(self, provider_id: str) -> dict:
        ...
        with self._lock:
            ...
            return {"entries": len(cache), "oldest_age_seconds": oldest_age}
    ...
    def evict_expired(self):
        ...
        with self._lock:
            ...
            for _cache_id, cache in self._caches.items():
