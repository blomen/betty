...
TEAM_PREFIXES = [
    ...
    "bc ",
    "hc ",
    "hk ",  # kk = kosarkaski klub (Serbian/Croatian)
    "cb ",
    "ck ",  # cb = club baloncesto (Spanish)
    # Arabic article
    "al ",
    "al-",
    # Gender/Age
    ...
    "cd ",
    "ud ",  # club deportivo, union deportiva (Spanish)
]
...
def normalize_market(market: str) -> str:
    ...
    is_match_winner = any(
        ...
        for kw in [
            ...
            "full time",
            "fulltid",
            "heltid",  # Swedish: fulltid/heltid = full time
            "match result",
            "helmatchen",
            "slutresultat",
            "will win",
            ...
            "winner",
            "förlängning",
            "forlangning",  # Swedish "including overtime"
            "ordinarie tid",
            "match_odds",  # Swedish "regular time"
        ]
    )
