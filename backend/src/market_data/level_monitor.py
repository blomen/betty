                    ...
                    if not _should_run_phase2_handlers(broker.tracker):
                        ...
                        try:
                            ...
                            if rev.get("should_exit") and _reversal_signals_active():
                                ...
                                # re-trail at the same level). OF-aware trail logic
                                # removed 2026-05-17 — same principle as the entry OF
                                # gate removal: trust the DQN's CONT action + the
                                # zone-trail geometry, don't gate trail behavior on
                                # the hand-coded OF composite.
