...
def compute_zone_trail_target(
    ...
    OF-aware trail tightening removed 2026-05-17: hand-coded thresholds
    on the OF composite were anti-predictive (same finding that pulled the
    entry OF gate). The DQN's CONT action + zone geometry now solely
    drives trail behavior.
    """
