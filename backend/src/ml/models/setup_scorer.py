...
FEATURE_NAMES_PHASE1 = [
    ...
    "delta_pct",
    "cvd_slope_5bar",
    "volume_ratio_vs_20bar",
    "volume_ratio_vs_session",
...
FEATURE_NAMES_PHASE2 = FEATURE_NAMES_PHASE1 + [
    "delta_divergence_bars",
    "delta_unwind_speed_bars",
    "cvd_slope_10bar",
    "cvd_acceleration",
    "body_ratio_last",
    "body_ratio_avg_3bar",
    ...
    "stop_run_magnitude_ticks",
    "stop_run_volume_ratio",
    "distance_to_vwap_ticks",
    "price_vs_vwap_sd",
    "va_width_ticks",
    "va_width_vs_yesterday",
    "single_print_count_above",
    "single_print_count_below",
    "num_levels_within_20_ticks",
    "rotation_factor",
    "aspr",
    "session_volume_total",
    "session_volume_acceleration",
    "news_event_minutes_away",
    "news_event_importance",
    "unfinished_auction_count_above",
    "unfinished_auction_count_below",
]
...
SETUP_TYPE_MAP = {
    ...
    "rule_80": 4,
    "fakeout": 5,
    "break_from_balance": 6,
    "double_distribution": 7,
    "news_directional": 8,
}
