...
export type TabName = 'monitor' | 'value' | 'dutch' | 'reverse' | 'polymarket' | 'combos' | 'stats' | 'bankroll' | 'specials' | 'profiles' | 'tradingBankroll' | 'tradingToday' | 'tradingBuilder' | 'tradingTrades' | 'tradingJournal';
